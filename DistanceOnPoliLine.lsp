        ...
        (progn
          ...
          (if pt2_raw
            (progn
              ...
              (alert (strcat "Довжина сегмента полілінії між найближчими точками: " (rtos seg_length 2 4)))
              (prompt (strcat "\nДовжина сегмента полілінії між найближчими точками до вказаних: " (rtos seg_length 2 4)))
            )
